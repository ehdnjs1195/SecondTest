...
<body>
	<form action="${pageContext.request.contextPath }/users/login.do" method="post" class="login-form">
		<h1>Login</h1>
		...
		<div class="bottom-text">
			Don't have account? <a href="${pageContext.request.contextPath }/users/signup_form.do">Sign up</a>
		</div>
	</form>
