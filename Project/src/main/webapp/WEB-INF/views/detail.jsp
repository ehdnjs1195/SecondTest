	...
	<div class="container" style="color: white;">
		...
		<div class="movie_summary">
			...
			<form id="favorite_form" class="favorite_form" action=""
				...
				<input type="hidden" name="movieId" value="${dto.movieId }" /> <input
					type="hidden" name="movieSeq" value="${dto.movieSeq }" /> <input
					type="hidden" name="repRlsDate" value="${dto.repRlsDate }" /> <input
					type="hidden" name="title" value="${dto.title }" /> <input
					type="hidden" name="genre" value="${dto.genre }" /> <input
					type="hidden" name="posters" value="${dto.posters }" />
		...
		<div class="desc_movie"
			style="clear: left; font-weight: bold; padding-top: 28px;">
		...
		<div class="comments">
			...
			<div class="comment_form">
				<form action="comment_insert.do" method="post">
					...
					<textarea class="form-control" name="content" style="color: black;"><c:if
					...
					<c:choose>
						...
						<c:when test="${tmp.deleted ne 'yes' }">
							<li class="comment" id="comment${tmp.num }"
									...
									<dt>
										...
										<c:choose>
											...
											<c:when test="${id eq tmp.writer }">
												<a href="javascript:" class="comment-update-link"
													style="color: #00c851;">수정</a>&nbsp;&nbsp;
										<a href="javascript:deleteComment(${tmp.num })"
													style="color: #00c851;">삭제</a>
											</c:when>
											<c:otherwise>
								...
								</dl> <!-- 대댓글 form css 에 display: none; -->
								<form class="comment-insert-form" action="comment_insert.do"
									...
									<textarea name="content" style="color: black;"><c:if
											test="${empty id }">로그인이 필요합니다.</c:if></textarea>
									<button type="submit" style="color: black;">등록</button>
