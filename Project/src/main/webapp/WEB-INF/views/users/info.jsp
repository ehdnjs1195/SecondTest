...
<body>
	...
	<div class="container" id="info-form">
		<a href="javascript:" id="profileLink"> <c:choose>
		...
		<h4>
			<span style="font-weight: bold;"> 관심목록 | 
			<c:choose>
		...
		<p>
			<span style="font-weight: bold;">개인정보 | </span> <a
				href="updateform.do"> 수정하기</a>
		</p>
		<p>
			<span style="font-weight: bold;">비밀번호 | </span> <span><a
				href="pwd_updateform.do">수정하기</a></span>
		</p>
		<p>
			<span style="font-weight: bold;">이메일 |</span> <span>${dto.email }</span>
		</p>

		<p>
			<span style="font-weight: bold;">가입일 |</span> 
			<span>
			<fmt:parseDate var="dateFmt" pattern="yyyy-MM-dd HH:mm:ss.SSS" value="${dto.regdate}" />
			<fmt:formatDate var="dateParse" pattern="yyyy년MM월dd일 HH시mm분" value="${dateFmt}" />
	...
	<form action="profile_upload.do" method="post"
		...
		<label for="profileImage">프로필 이미지 선택</label> <input type="file"
